...
COMMENT_XML = """<w:comment w:id="{id}" w:author="{author}" w:date="{date}" w:initials="{initials}">
...
COMMENT_MARKER_TEMPLATE = """Add to document.xml (markers must be direct children of w:p, never inside w:r):
...
REPLY_MARKER_TEMPLATE = """Nest markers inside parent {pid}'s markers (markers must be direct children of w:p, never inside w:r):
